...
import {getSectionsData} from '../ManagePreferences/ManagePage.duck';
...
class LandingPageComponent extends Component {
  ...
  render() {
    ...
    let section_1, section_2,section_3 = {
      title: '',
      description:'',
      items: []
    }
            ...
            <ul className={css.sections}>
              <li className={css.section}>
                <div className={css.sectionContentFirstChild}>
                  <SectionLocations data={section_1} />
                </div>
              </li>

              <li className={css.section}>
                <div className={css.sectionContentFirstChild}>
                  <SectionPropertyType data={section_2} />
                </div>
              </li>

              <li className={css.section}>
                <div className={css.sectionContentFirstChild}>
                  <SectionSubCats data={section_3} />
                </div>
              </li>
...
const mapStateToProps = state => {
  ...
  const { sections } = managePageReducer;
...
const mapDispatchToProps = dispatch => {
  ...
  return {
    loadSectionData: () => {dispatch(getSectionsData())}
  }
